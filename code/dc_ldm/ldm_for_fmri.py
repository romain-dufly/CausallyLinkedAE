...
class fLDM:
    ...
    def finetune(self, trainers, dataset, test_dataset, bs1, lr1,
        ...
        test_loader = DataLoader(test_dataset, batch_size=len(test_dataset), shuffle=False, num_workers=0) ##### num workers
    ...
    @torch.no_grad()
    def generate(self, fmri_embedding, num_samples, ddim_steps=200, HW=None, limit=None, state=None, vqgan_model=None):
