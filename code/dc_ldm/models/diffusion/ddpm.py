        ...
        with model.ema_scope():
            for count, item in enumerate(zip(data['fmri'], data['image'])):
                ...
                if gt_image.shape[2] < x_samples_ddim.shape[2]:
                    gt_image = F.pad(gt_image, (0, x_samples_ddim.shape[2] - gt_image.shape[2], 0, x_samples_ddim.shape[3] - gt_image.shape[3]), mode='constant', value=0)
                print(gt_image.shape, x_samples_ddim.shape)
